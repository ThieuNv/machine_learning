...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 29 13:11:32 2017
...
def decrease_list_hidden_unit(list_hus, matrix_weights, percent=0.13, sort=True, how=1):
    if sort == True:
        ...
        matrix_weights = copy.deepcopy(my_sorted(matrix_weights, key_function=square, key_id=1))
        list_hus = copy.deepcopy(my_sorted(list_hus, key_function=take_second_and_square, key_id=2))
...
full_path= "/mnt/volume/ggcluster/spark-2.1.1-bin-hadoop2.7/thieunv/machine_learning/6_google_trace/SONIA/testing/no_mutation/no_update/pruning/result/cpu_ram/"
