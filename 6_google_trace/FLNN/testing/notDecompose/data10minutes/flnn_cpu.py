...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 24 13:28:10 2017
...
full_path= "/mnt/volume/ggcluster/spark-2.1.1-bin-hadoop2.7/thieunv/machine_learning/6_google_trace/FLNN/testing/notDecompose/data10minutes/univariate/cpu/"
...
df = read_csv(full_path_name+ file_name, header=None, index_col=False, usecols=[0], engine='python')    # (10)
