...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 31 02:15:00 2017
...
full_path= "/mnt/volume/ggcluster/spark-2.1.1-bin-hadoop2.7/thieunv/machine_learning/6_google_trace/FLNN/testing/notDecompose/data10minutes/univariate/disk_space/"
...
df = read_csv(full_path_name+ file_name, header=None, index_col=False, usecols=[3], engine='python')    # (10)
